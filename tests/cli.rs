...
mod unix {
    ...
    fn doctor_checks_versions_and_the_installed_channel() {
        ...
        Command::cargo_bin("jtv")
            ...
            .env("JTV_JUST", &just)
            .env("JTV_TV", &tv)
            .env_remove("JTV_SHELL_INTEGRATION")
            .env_remove("JTV_HISTORY_PROTOCOL")
            .env_remove("JTV_HISTORY_SESSION")
            .env_remove("JTV_ZSH_AUTOSUGGESTIONS")
            .env_remove("JTV_ATUIN_BIN")
            .env_remove("ATUIN_SESSION")
            .arg("doctor")
            .assert()
            .success()
